...
In case you are not using ubuntu, please see the [installation](https://docs.docker.com/engine/installation/linux/) instructions for your distribution.
...
af036d6c888e6e18b3914834bd157538ef2b5005bb876fdec598c8c0a6aa8bf4
```

Lets now connect to the nginx container by **inspecting** it first**

Get the container id by listing all the docker processes
...
af036d6c888e        nginx               "nginx -g 'daemon of…"   About a minute ago   Up 58 seconds       80/tcp              suspicious_wozniak
```
...
```
Run a curl to the ip address to access the container 
